...
function getPosts(userId) {
    return __awaiter(this, void 0, void 0, function () {
        var response, posts, cleanedPosts, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, node_fetch_1.default("https://jsonplaceholder.typicode.com/users/" + userId + "/posts")];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.json()];
                case 2:
                    posts = _a.sent();
                    cleanedPosts = posts.map(function (post) {
                        delete post["userId"];
                        return post;
                    });
                    return [2 /*return*/, cleanedPosts];
                case 3:
                    e_1 = _a.sent();
...
var main = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getPosts(1)];
            case 1:
                result = _a.sent();
                console.log(result);
                return [2 /*return*/];
